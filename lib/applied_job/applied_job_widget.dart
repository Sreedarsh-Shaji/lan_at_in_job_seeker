...
class AppliedJobWidget extends StatefulWidget {
  const AppliedJobWidget({Key key}) : super(key: key);

  @override
  _AppliedJobWidgetState createState() => _AppliedJobWidgetState();
}
                  ...
                  Expanded(
                    child: Align(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: GetAppliedPositionByIdCall.call(
                          id: FFAppState().uuid,
                        ),
                        builder: (context, snapshot) {
                          ...
                          final columnGetAppliedPositionByIdResponse =
                              snapshot.data;
                          return Builder(
                            builder: (context) {
                              final vacancies = getJsonField(
                                    (columnGetAppliedPositionByIdResponse
                                            ?.jsonBody ??
                                        ''),
                                    r'''$.profile''',
                                  )?.toList() ??
